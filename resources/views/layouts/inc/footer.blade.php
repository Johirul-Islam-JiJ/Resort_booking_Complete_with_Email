...
<html lang="en">
  <head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Nunito+Sans:300,400,600,700&display=swap" rel="stylesheet">
		...
		<link rel="stylesheet" href="{{ asset('footer/css/ionicons.min.css') }}">
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <script src="{{ asset('footer/js/jquery.min.js') }}"></script>
    <script src="{{ asset('footer/js/popper.js') }}"></script>
    <script src="{{ asset('footer/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('footer/js/main.js') }}"></script>
  </body>
</html>
